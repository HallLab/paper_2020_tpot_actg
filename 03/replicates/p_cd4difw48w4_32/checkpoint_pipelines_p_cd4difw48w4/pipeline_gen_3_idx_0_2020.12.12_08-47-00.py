...
# Average CV score on the training set was: 0.030495066217458254
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4347, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.55),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=43, p=1, weights="distance")
)
