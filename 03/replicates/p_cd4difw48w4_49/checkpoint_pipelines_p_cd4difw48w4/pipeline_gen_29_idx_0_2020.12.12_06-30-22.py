...
# Average CV score on the training set was: 0.08929988956277293
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=2541, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Nystroem(gamma=0.30000000000000004, kernel="linear", n_components=10),
    AddIntercept(),
    LinearSVR(C=10.0, dual=True, epsilon=0.1, loss="epsilon_insensitive", tol=0.001)
)
