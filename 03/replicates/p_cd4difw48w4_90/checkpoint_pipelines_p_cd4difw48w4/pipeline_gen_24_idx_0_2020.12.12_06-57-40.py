...
# Average CV score on the training set was: 0.12652582341003016
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=1262, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.9500000000000001),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=1, min_samples_leaf=9, min_samples_split=2)
)
