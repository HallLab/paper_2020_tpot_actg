...
# Average CV score on the training set was: -0.005307496567008574
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3006, subset_list="../02/c7.all.v7.0.symbols.csv"),
    MaxAbsScaler(),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=99, p=2, weights="uniform")
)
