...
# Average CV score on the training set was: 0.05729166273893047
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4383, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.1),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=15, p=2, weights="uniform")
)
