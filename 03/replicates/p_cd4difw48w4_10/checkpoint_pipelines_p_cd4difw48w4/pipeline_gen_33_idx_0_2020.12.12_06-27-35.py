...
# Average CV score on the training set was: 0.05802242016920285
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4053, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="l2", linkage="complete"),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=2, min_samples_leaf=19, min_samples_split=3)
)
