...
# Average CV score on the training set was: 0.11069270800704309
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3685, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="l2", linkage="complete"),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=10, min_samples_leaf=17, min_samples_split=16)
)
