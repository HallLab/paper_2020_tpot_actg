...
# Average CV score on the training set was: 0.12675126062757386
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=1551, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.5),
    AddIntercept(),
    LinearSVR(C=0.5, dual=False, epsilon=0.001, loss="squared_epsilon_insensitive", tol=0.0001)
)
