...
# Average CV score on the training set was: 0.02537963748519314
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=1591, subset_list="../02/c7.all.v7.0.symbols.csv"),
    PCA(iterated_power=2, svd_solver="randomized"),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=42, p=1, weights="distance")
)
