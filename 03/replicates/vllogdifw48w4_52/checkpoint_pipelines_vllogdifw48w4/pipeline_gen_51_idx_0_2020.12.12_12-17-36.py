...
# Average CV score on the training set was: 0.11374332003915051
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=2384, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.8500000000000001),
    AddIntercept(),
    LinearSVR(C=0.5, dual=True, epsilon=0.01, loss="squared_epsilon_insensitive", tol=1e-05)
)
