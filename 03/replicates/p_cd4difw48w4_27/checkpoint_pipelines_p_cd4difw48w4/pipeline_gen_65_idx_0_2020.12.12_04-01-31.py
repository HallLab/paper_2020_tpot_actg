...
# Average CV score on the training set was: 0.12780171881191088
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3817, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.2),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=1, min_samples_leaf=18, min_samples_split=19)
)
