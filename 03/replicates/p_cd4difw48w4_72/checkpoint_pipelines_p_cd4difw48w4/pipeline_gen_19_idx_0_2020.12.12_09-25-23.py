...
# Average CV score on the training set was: 0.10220481345392891
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=2154, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.7000000000000001),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=1, min_samples_leaf=13, min_samples_split=18)
)
