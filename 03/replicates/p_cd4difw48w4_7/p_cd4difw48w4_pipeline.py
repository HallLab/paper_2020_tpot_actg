...
# Average CV score on the training set was: 0.1064864015751881
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=2749, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Binarizer(threshold=0.15000000000000002),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=2, min_samples_leaf=9, min_samples_split=15)
)
