...
# Average CV score on the training set was: 0.005497114685367954
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3082, subset_list="../02/c7.all.v7.0.symbols.csv"),
    PCA(iterated_power=3, svd_solver="randomized"),
    AddIntercept(),
    LinearSVR(C=0.0001, dual=False, epsilon=0.001, loss="squared_epsilon_insensitive", tol=0.0001)
)
