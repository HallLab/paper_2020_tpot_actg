...
# Average CV score on the training set was: -0.008936095196371018
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=942, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.9500000000000001),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=92, p=2, weights="uniform")
)
