...
# Average CV score on the training set was: 0.09668099940210217
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=1123, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.25),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=6, p=2, weights="distance")
)
