...
# Average CV score on the training set was: 0.018299083268480155
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4248, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.75),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=72, p=1, weights="uniform")
)
