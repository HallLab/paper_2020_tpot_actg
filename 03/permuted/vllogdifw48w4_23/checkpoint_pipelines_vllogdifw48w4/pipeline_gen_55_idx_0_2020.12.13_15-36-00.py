...
# Average CV score on the training set was: 0.07948809313900125
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3487, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Binarizer(threshold=0.7000000000000001),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=2, min_samples_leaf=15, min_samples_split=13)
)
