...
# Average CV score on the training set was: 0.011028373311062944
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3118, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Nystroem(gamma=0.9, kernel="additive_chi2", n_components=7),
    AddIntercept(),
