...
# Average CV score on the training set was: 0.00026674288365573505
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3103, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="euclidean", linkage="ward"),
    AddIntercept(),
    LinearSVR(C=15.0, dual=False, epsilon=0.0001, loss="squared_epsilon_insensitive", tol=1e-05)
)
