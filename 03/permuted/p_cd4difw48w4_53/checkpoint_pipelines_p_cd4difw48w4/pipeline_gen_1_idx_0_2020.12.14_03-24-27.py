...
# Average CV score on the training set was: -0.0029668012250961386
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=1734, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Binarizer(threshold=0.30000000000000004),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=3, min_samples_leaf=9, min_samples_split=15)
)
