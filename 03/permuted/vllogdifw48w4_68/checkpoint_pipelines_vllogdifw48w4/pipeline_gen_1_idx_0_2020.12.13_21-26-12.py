...
# Average CV score on the training set was: -0.051780276562563364
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3051, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="l1", linkage="complete"),
    AddIntercept(),
    LinearSVR(C=0.0001, dual=False, epsilon=0.01, loss="squared_epsilon_insensitive", tol=0.01)
)
