...
# Average CV score on the training set was: 0.0015048031152004927
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=40, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=1.0),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=66, p=1, weights="distance")
)
