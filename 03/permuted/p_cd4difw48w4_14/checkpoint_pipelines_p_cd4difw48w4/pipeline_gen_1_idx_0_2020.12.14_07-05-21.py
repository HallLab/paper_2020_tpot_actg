...
# Average CV score on the training set was: -0.0004755151902629207
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4191, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Binarizer(threshold=0.2),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=79, p=2, weights="uniform")
)
