...
# Average CV score on the training set was: 0.062269025704541424
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=3903, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="manhattan", linkage="average"),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=52, p=2, weights="distance")
)
