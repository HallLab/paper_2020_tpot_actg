...
# Average CV score on the training set was: 0.10250787009493142
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4810, subset_list="../02/c7.all.v7.0.symbols.csv"),
    FeatureAgglomeration(affinity="l1", linkage="average"),
    AddIntercept(),
    KNeighborsRegressor(n_neighbors=55, p=1, weights="distance")
)
