...
# Average CV score on the training set was: 0.12249073479015749
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=868, subset_list="../02/c7.all.v7.0.symbols.csv"),
    Binarizer(threshold=0.55),
    AddIntercept(),
    DecisionTreeRegressor(max_depth=4, min_samples_leaf=17, min_samples_split=18)
)
