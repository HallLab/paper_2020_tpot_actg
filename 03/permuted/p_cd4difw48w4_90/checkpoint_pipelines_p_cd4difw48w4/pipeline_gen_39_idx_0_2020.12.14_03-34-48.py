...
# Average CV score on the training set was: 0.08810723678953436
exported_pipeline = make_pipeline(
    FeatureSetSelector(sel_subset=4567, subset_list="../02/c7.all.v7.0.symbols.csv"),
    RBFSampler(gamma=0.45),
    AddIntercept(),
    LinearSVR(C=0.5, dual=False, epsilon=0.01, loss="squared_epsilon_insensitive", tol=0.0001)
)
